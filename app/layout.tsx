...
export default function RootLayout({children}:Readonly<{children:React.ReactNode}>){return <html lang="ar" dir="rtl"><body><LanguageProvider><SiteExperience/>{children}</LanguageProvider><noscript><style>{".site-intro{display:none!important}"}</style></noscript></body></html>}
